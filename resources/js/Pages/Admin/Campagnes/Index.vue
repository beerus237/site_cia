        ...
        <div v-for="campagne in campagnes" :key="campagne.id" class="surface-card-hover overflow-hidden">
          ...
          <div class="p-4">
            ...
            <div class="flex items-center justify-between border-t border-slate-100 pt-3">
              <Link :href="`/admin/contributions?campagne_id=${campagne.id}`" class="text-xs font-medium text-brand-600 hover:text-brand-700 hover:underline">
                {{ campagne.contributions_count }} contribution(s)
              </Link>
