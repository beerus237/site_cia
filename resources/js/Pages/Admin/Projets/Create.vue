<!-- resources/js/Pages/Admin/Projets/Create.vue -->
<template>
  <AdminLayout
    :title="isEdit ? 'Modifier le projet' : 'Créer un projet'"
    :description="isEdit ? 'Modifiez un projet existant' : 'Ajoutez un nouveau projet'"
  >
    <div class="mx-auto max-w-4xl">
      <div class="mb-6 flex items-center justify-between">
        ...
        <Link href="/admin/projets" class="text-sm font-semibold text-brand-600 hover:text-brand-700">
...
const submit = () => {
  if (isEdit) {
    ...
    form.post('/admin/projets', { forceFormData: true })
  }
}
</script>
